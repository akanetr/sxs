...
(function() {
  ...
  Window_SoloStatus.prototype.constructor = Window_Status;
...
//    this.refresh();
  ...
  Window_Base.prototype.drawCurrencyValue = function (value, unit, wx, wy, ww) {
      ...
      this.drawText(text, wx - 32, wy, ww - cx - 4, 'right');
      if (unit) {
          this.drawIcon(313, wx - 32 + ww - Window_Base._iconWidth, wy + 2);
      } else {
          this.changeTextColor(this.systemColor());
  ...
  Scene_Menu.prototype.createGoldWindow = function() {
    ...
    this._goldWindow.y = +goldWindow.y;
      //■■■■■■■■■■■■■■■■■■■■■■■■■
    this._goldWindow.width = +goldWindow.width;
      //■■■■■■■■■■■■■■■■■■■■■■■■■
