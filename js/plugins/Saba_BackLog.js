 ...
 * 
 * @param Backlogを表示
 * @desc Backlogを表示する (0:OFF 1:ON)。『Saba_BackLog show_id』のプラグインコマンド『on=1』『off=0』での切り替えも可能に改造
 * @default 1
 *   
 * @param backLogButton
...
//        var show_id = Number(param['Backlogを表示'])||1;
        var show_id = Number(param['Backlogを表示']);
...
//            testtt = false;
//			var testtt = parameters['Saba_R_visibleSwitch'];
			if(show_id)
			{
